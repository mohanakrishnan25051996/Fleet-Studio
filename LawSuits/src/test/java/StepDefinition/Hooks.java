...
public class Hooks extends BaseTest {
	...
	public void before(Scenario scenario) throws Throwable{
		Hooks.scenario =scenario;
		 ...
		 datahandler= new DataHandler(System.getProperty("user.dir")+"/src/test/java/DataSheet/Accessbility.xls",FeatureName,scenario.getName());
		 TestData=DataHandler.ReadExcel();
		 super.setup(scenario, scenario.getName(), TestData);
		 webdriver=getDriver();
		 }
